    ...
    <nav class="das text-white shadow-md">
        <div class="container mx-auto px-6 py-3 flex justify-between items-center">
            <div class="flex  items-center">
                ...
                <a href="dashboard.php" class="py-2 px-3 hover:bg-orange-100 font-semibold bg-orange-700 hover:text-orange-900 rounded-md">Dashboard</a>
                   
                    <a href="users.php" class="py-2 px-3 hover:bg-orange-100 font-semibold hover:text-orange-900 rounded-md">Users</a>
