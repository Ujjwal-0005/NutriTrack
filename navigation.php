...
<nav class="container mx-auto px-6 py-4">
    <div class="flex justify-between items-center">
        ...
        <div class="space-x-4 hidden md:flex items-center">
            <a href="index.php" class="text-secondary p-[8px]   hover:text-white hover:font-bold text-white transition">Home</a>
            <?php if (isset($_SESSION['firstname'])): ?>
                <a href="dashboard/user.php" class="hover:text-white text-white hover:font-bold  transition">Dashboard</a>
                <a href="dashboard/challenges.php" class="py-2 px-3 bg-indigo-700 rounded-md">Challenges</a>
                <a href="settings/user.php" class="hover:text-white text-white hover:font-bold  transition">Profile</a>
